      ...
      <div class="grid-group">
        ...
        <div class="grid-item">
          ...
          <input
            ...
            :placeholder="training.mainTitle"
          />
        </div>
        ...
        <div class="grid-item">
          ...
          <textarea
            ...
            :placeholder="training.metaDescription || training.intro"
          ></textarea>
        </div>
      </div>
      ...
      <div class="grid-group">
        ...
        <div class="grid-item">
          ...
          <input
            ...
            :placeholder="training.author.name"
          />
        </div>
      ...
      <div class="grid-group">
        ...
        <div class="grid-item">
          ...
          <input
            ...
            :placeholder="training.tags.join(', ')"
          />
        </div>
        ...
        <div class="grid-item">
          ...
          <input
            ...
            "
            :placeholder="
              training.url || 'https://example.com/your-article-url'
            "
          />
        </div>
      ...
      <div class="grid-group">
        ...
        <div class="grid-item">
          ...
          <input
            ...
            placeholder="Training series or collection name (optional)"
          />
        </div>
...
const structuredData = computed(() => {
  return {
    headline: props.training?.structuredData?.headline || "",
    alternativeHeadline:
      props.training?.structuredData?.alternativeHeadline || "",
    description: props.training?.structuredData?.description || "",
    image: props.training?.structuredData?.image || { url: "", caption: "" },
    author: props.training?.structuredData?.author || { name: "", url: "" },
    publisher: props.training?.structuredData?.publisher || {
      name: "",
      logo: { url: "" },
    },
    datePublished: props.training?.structuredData?.datePublished || "",
    dateModified: props.training?.structuredData?.dateModified || "",
    keywords: props.training?.structuredData?.keywords || "",
    articleSection: props.training?.structuredData?.articleSection || "",
    mainEntityOfPage: props.training?.structuredData?.mainEntityOfPage || {
      "@id": "",
    },
    about: props.training?.structuredData?.about || { name: "" },
    mentions: props.training?.structuredData?.mentions || [{ name: "" }],
    discussionUrl: props.training?.structuredData?.discussionUrl || "",
    isPartOf: props.training?.structuredData?.isPartOf || { name: "" },
    inLanguage: props.training?.structuredData?.inLanguage || {
      name: "English",
    },
    video: props.training?.structuredData?.video || {
      name: "",
      url: "",
      thumbnailUrl: "",
      uploadDate: "",
    },
    interactionStatistic: props.training?.structuredData
      ?.interactionStatistic || {
      userInteractionCount: "",
    },
    license: props.training?.structuredData?.license || "",
    accessMode: props.training?.structuredData?.accessMode || "",
    accessModeSufficient:
      props.training?.structuredData?.accessModeSufficient || "",
    accessibilitySummary:
      props.training?.structuredData?.accessibilitySummary || "",
    category: props.training?.structuredData?.category || "",
    copyrightHolder: props.training?.structuredData?.copyrightHolder || "",
    copyrightYear: props.training?.structuredData?.copyrightYear || "",
    isFamilyFriendly: props.training?.structuredData?.isFamilyFriendly || "",
  };
});
